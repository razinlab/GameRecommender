...
# Secret key for JWT tokens - should be in environment variable on prod
...
def register():
    ...
    try:
        ...
        user_id = secrets.token_hex(8)  # Generate a unique user ID
...
def login():
    ...
    try:
        ...
        try:
            ...
            # Fallback for PyJWT v1.x
            import jwt as pyjwt
            token = pyjwt.encode(token_payload, SECRET_KEY, algorithm="HS256").decode('utf-8')
...
def save_game():
    ...
    try:
        # Check if game is already saved - composite key of user_id and game_id
